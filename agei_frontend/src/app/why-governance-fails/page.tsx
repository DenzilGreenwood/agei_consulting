      ...
      <div className="space-y-12">
        <Card>
          ...
          <CardContent>
            ...
            <div className="bg-muted p-4 rounded-md border border-border">
              <strong className="text-foreground">The CognitiveInsight Solution:</strong> We turn human-authored policies into machine-evaluable rules stored directly in your database, enforcing compliance at the code level before code execution.
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="bg-muted p-4 rounded-md border border-border">
              <strong className="text-foreground">The CognitiveInsight Solution:</strong> We deploy purpose-limited signal collection to convert unmanaged usage into structured Discovery Records. We classify risk based on data sensitivity and route users into sanctioned enterprise alternatives.
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="bg-muted p-4 rounded-md border border-border">
              <strong className="text-foreground">The CognitiveInsight Solution:</strong> We enforce Pre-Action Proofs. No autonomous agent can execute a sensitive tool wrapper without carrying a cryptographically signed proof bundle that matches active privilege policies.
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="bg-muted p-4 rounded-md border border-border">
              <strong className="text-foreground">The CognitiveInsight Solution:</strong> We implement a dedicated Tamper-Evident Evidence Vault. Every governed lifecycle transition produces an immutable, Ed25519-signed Receipt sealed into durable vault objects that prove complete chain of custody.
            </div>
          </CardContent>
        </Card>
      </div>
