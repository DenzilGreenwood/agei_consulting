  ...
  return (
    <div className="container mx-auto px-4 py-20 max-w-5xl">
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-6 text-foreground">A Transparent Roadmap to Verifiable Trust.</h1>
      ...
      <div className="relative border-l-2 border-border ml-6 md:ml-12 pl-8 md:pl-12 space-y-16 py-8">
        ...
        <div className="relative">
          ...
          <Card>
            <CardHeader className="bg-primary text-primary-foreground/5 border-b border-border">
            ...
            <CardContent className="pt-6">
              ...
              <div className="bg-background p-3 rounded border border-border inline-block">
                <span className="text-foreground font-medium">Primary Deliverable:</span> Shadow AI Evidence Perimeter Scan & Discovery Audit.
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="relative">
          ...
          <Card className="border-accent">
            <CardHeader className="bg-primary text-primary-foreground/10 border-b border-border">
              <div className="flex flex-col md:flex-row md:justify-between md:items-center">
                <CardTitle className="text-2xl text-primary">Design & Align (Most Popular)</CardTitle>
                <div className="timeline-badge">
            ...
            <CardContent className="pt-6">
              ...
              <div className="bg-background p-3 rounded border border-border inline-block">
                <span className="text-foreground font-medium">Primary Deliverable:</span> Executable Gate Modeling & Schema Design.
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="relative">
          ...
          <Card>
            ...
            <CardContent className="pt-6">
              ...
              <div className="bg-background p-3 rounded border border-border inline-block">
                <span className="text-foreground font-medium">Primary Deliverable:</span> Evidence Vault & Sidecar SDK Production Integration.
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="relative">
          ...
          <Card>
            ...
            <CardContent className="pt-6">
              ...
              <div className="bg-background p-3 rounded border border-border inline-block">
                <span className="text-foreground font-medium">Primary Deliverable:</span> Continuous Assurance & Automated Audit Packs.
              </div>
            </CardContent>
          </Card>
        </div>
